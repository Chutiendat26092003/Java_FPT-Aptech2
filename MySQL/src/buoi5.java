...
public class buoi5 {
    public static void main(String[] args) {
        ...
        try (
            ...
            /*Để thực thi lệnh SQL SELECT, ta gọi phương thức stmt.executeQuery(strSelect)
            trả về kết quả truy vấn trong ResultSet đối tượng(được gọi resultSet) */
            ResultSet resultSet = stmt.executeQuery(strSelect); /*Mô hình bảng được trả về,
            có thể truy cập thông qua 1 con trỏ hàng*/
